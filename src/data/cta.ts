...
export const ctas: Record<ResultType, CtaContent> = {
  writing: {
    ...
    buttonLabel: '30日間の行動計画を見る',
    pendingLabel: '準備中',
    pendingMessage: '詳細版は準備中です。今は上の行動計画を見ながら、まずX投稿の下書き1本から始めてください。',
  ...
  creative: {
    ...
    buttonLabel: '30日間の行動計画を見る',
    pendingLabel: '準備中',
    pendingMessage: '詳細版は準備中です。今は上の行動計画を見ながら、まず身近なジャンルを1つ選んでください。',
  ...
  tool: {
    ...
    buttonLabel: '30日間の行動計画を見る',
    pendingLabel: '準備中',
    pendingMessage: '詳細版は準備中です。今は上の行動計画を見ながら、まず3画面メモを書いてください。',
  ...
  research: {
    ...
    buttonLabel: '30日間の行動計画を見る',
    pendingLabel: '準備中',
    pendingMessage: '詳細版は準備中です。今は上の行動計画を見ながら、まず気になるテーマを1つ選んでください。',
